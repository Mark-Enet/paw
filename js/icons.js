  ...
  window.PAW_ICONS = {
    ...
    settings: function () {
      return ic(
        ...
        '<path d="M7 2.2l.8.2.4 1.1.9.5 1.1-.2.6.6-.2 1.1.5.9 1.1.4.2.8-.2.8-1.1.4-.5.9.2 1.1-.6.6-1.1-.2-.9.5-.4 1.1-.8.2-.8-.2-.4-1.1-.9-.5-1.1.2-.6-.6.2-1.1-.5-.9-1.1-.4-.2-.8.2-.8 1.1-.4.5-.9-.2-1.1.6-.6 1.1.2.9-.5.4-1.1z"/>',
        13, 13, 'vertical-align:text-bottom;margin-right:3px'
      );
    },
